...
class OnboardingViewController: UIViewController {
    ...
    lazy var onboardingScrollView: UIScrollView = {
        ...
        scrollView.bounces = false //не получится протащить картинку так, чтобы стало видно черную область
        scrollView.contentInsetAdjustmentBehavior = .never //позволяет игнорировать safe area insets
        return scrollView
    }()
